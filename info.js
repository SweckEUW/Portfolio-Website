let info = {
  ...
  logo_name: "paul",
  flat_picture: ("./src/assets/potrait.jpg"),
  config: {
    use_cookies: true,
    navbar: {
      blur: false
  ...
  portfolio_design: [
    {
      ...
      pictures: [
        {
          img: ("./src/assets/designs/coursera1/MoodBoard.png"),
          title: "MoodBoard"
        },
        {
          img: ("./src/assets/designs/coursera1/Mockups 1.png"),
          title: "Mockups 1"
        },
        {
          img: ("./src/assets/designs/coursera1/Mockups 2.png"),
          title: "Mockups 2"
        },
        {
          img: ("./src/assets/designs/coursera1/App Elements.png"),
          title: "App Elements"
        }
      ],
    ...
    },
    {
      ...
      pictures: [
        {
          img: ("./src/assets/designs/pantree/MoodBoard.png"),
          title: "Moodboard"
        },
        {
          img: ("./src/assets/designs/pantree/1.png"),
          title: "Mockups 1"
        },
        {
          img: ("./src/assets/designs/pantree/2.png"),
          title: "Mockups 2"
        }
      ],
      technologies: ["XD", "Illustrator"],
    ...
    },
    {
      ...
      pictures: [
        {
          img: ("./src/assets/designs/bunder/Moodboard.png"),
          title: "Moodboard"
        },
        {
          img: ("./src/assets/designs/bunder/Mockup 1.png"),
          title: "Mockup 1"
        },
        {
          img: ("./src/assets/designs/bunder/Mockup 2.png"),
          title: "Mockup 2"
        },
        {
          img: ("./src/assets/designs/bunder/Mockup 3.png"),
          title: "Mockup 3"
        },
        {
          img: ("./src/assets/designs/bunder/Market Research 1.png"),
          title: "Market Research 1"
        },
        {
          img: ("./src/assets/designs/bunder/Market Research 2.png"),
